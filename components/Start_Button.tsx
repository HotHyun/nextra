...
const Start_Button = (props) => {
  ...
  return (
    <Link href={`${props.query}/${URL_Result}`}>
      <button className="group w-full bg-white dark:bg-neutral-900 rounded-lg shadow-sm shadow-gray-200 border-gray-200 border mt-8 mr-4 hover:shadow-md hover:shadow-gray-100 hover:border-gray-300 duration-200">
